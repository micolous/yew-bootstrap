...
pub fn DropdownMenu(props: &DropdownMenuProps) -> Html {
    ...
    // TODO: There are a few different variants of this:
    // https://getbootstrap.com/docs/5.3/components/dropdowns/
    //
    // * <ul>: handled
    // * Use in a navbar (need to update existing)
    //
    // These use <div .dropdown-menu>, rather than <ul>:
    // * text content (https://getbootstrap.com/docs/5.3/components/dropdowns/#text)
    // * forms (https://getbootstrap.com/docs/5.3/components/dropdowns/#forms)
    //
    // Wrapped in a parent <div>:
    // * directions / centreing
    // * drop-up
    // * drop-end
    // * drop-start
    //
